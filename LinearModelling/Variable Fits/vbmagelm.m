...
imgsave(betahat, 'vbm_agelm_agecoeff', CSI)
imgsave(alphahat, 'vbm_agelm_intercept', CSI)
...
imgsave(sigma2, 'vbm_agelm_sigma2', CSI)
...
imgsave(tage, 'vbm_agelm_tage', CSI)

%%
R2 = F2R(tage.^2,nsubj,2,1);
imgsave(R2,'vbm_agelm_R2age',CSI);
