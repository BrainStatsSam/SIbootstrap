function plotXbars_max( type, groupsize, masktype, thresh, no_axis_limits, nboot )
...
out = prep_Xbar_plots( type, groupsize, thresh, no_axis_limits, masktype );
Amax = out.Amax;
Bmax = out.Bmax;
type = out.type;
...
%% ests versus truth
clf
p1 = plot( out.trueatlocis(Bmax == 1), out.is(Bmax == 1),'o');
set(p1,'LineWidth',1.5);
hold on
p2 = plot( out.truenaiveboot(Amax == 1), out.naive(Amax == 1),'o');
set(p2,'LineWidth',1.5);
p3 = plot( out.truenaiveboot(Amax == 1), out.boot(Amax == 1),'o');
